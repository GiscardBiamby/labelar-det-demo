...
r"""Convert raw bidmugs-COCO dataset to TFRecord for object_detection.

Please note that this tool creates sharded output files.

Example usage:
    python create_bidmugs_tf_record.py --logtostderr \
...
def main(_):
    ...
    train_output_path = os.path.join(FLAGS.output_dir, "bidmugs_train.record")
    val_output_path = os.path.join(FLAGS.output_dir, "bidmugs_val.record")
